      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          fullscreen
            ...
            : commandDeck
            ? "fixed inset-0 z-[60] flex flex-col w-full h-full bg-background text-foreground outline-none p-4 overflow-y-auto overscroll-contain no-scrollbar duration-150 sm:fixed sm:inset-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-[min(380px,calc(100vw-2rem))] sm:h-[min(600px,calc(100dvh-3rem))] sm:max-h-[calc(100dvh-3rem)] sm:rounded-3xl sm:bg-card sm:text-card-foreground sm:border sm:border-border sm:p-6 sm:shadow-none sm:overflow-y-auto sm:overscroll-contain data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95"
